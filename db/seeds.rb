...
Question.create(title:"Eri demasiado porro", a:"Persona que no estudia", b:"Persona que estudia mucho", c:"Persona que no entiende nada", country:"Chile", level:3)
Question.create(title:"Tirate un chancho nomas que pasa piola", a:"Expulsar un herupto ", b:"Expulsar un gas", c:"Gritar", country:"Chile", level:3)
Question.create(title:"El viejo pa' califa", a:"Adulto ambicioso al sexo", b:"Adulto sin gusto al sexo", c:"Hombre ambicioso a la comida", country:"Chile", level:3)
#3
Question.create(title:"Ando con caña", a:"Persona que tomo mucho alcohol", b:"Persona que tomo poco alcohol", c:"Persona que se siente muy ebrio", country:"Chile", level:3)
Question.create(title:"Dejate de bolsiar comida loco", a:"Pide comida todo el tiempo", b:"Pide tomar todo el tiempo", c:"Pide estudiar todo el tiempo", country:"Chile", level:3)
Question.create(title:"El medio poto", a:"Un trasero gigante", b:"Una sandia gigante ", c:"Una mitad de una naranja", country:"Chile", level:3)
#set del nivel 4
#1
Question.create(title:"Cacha a ese curao", a:"Mira a esa persona ebria", b:"Mira a ese indecente", c:"Quieres conocer a mi amigo", country:"Chile", level:4)
Question.create(title:"Sacate unas piscolits bro", a:"Compartir un pisco con CocaCola", b:"Compartir un pisco con Sprite", c:" Compartir un vaso de pisco", country:"Chile", level:4)
...
Question.create(title:"Quedo la caga!", a:"Ya no se puede hacer nada", b:"Todo esta mal", c:"Todo esta bien", country:"Chile", level:4)
Question.create(title:"No estoy ni ahí con vo", a:"No le interesa alguien ", b:"No le interesa la vida", c:"Esta muy interesadO en alguien", country:"Chile", level:4)
Question.create(title:"La cagaste pa' ser macabeo", a:"Ser controlado por su pareja", b:"Ser apegado su pareja", c:"No hacer nada", country:"Chile", level:4)
#set del nivel 5
#1
Question.create(title:"Teni la casa llena de cachureos", a:"Tienes cosas que no sirven", b:"Tener la casa llena de suciedad", c:"Tienes cosas que sirven", country:"Chile", level:5)
Question.create(title:"Filo con esa vola!", a:"Ya no importa esa situacion", b:"Es demasiado importante ", c:"Creo que importa", country:"Chile", level:5)
Question.create(title:"Ese compadre es terrible cuico", a:"Tiene mucho dinero", b:"No tiene cerebro", c:"Vive en curico", country:"Chile", level:5)
#5
Question.create(title:"Ese loco es terrible chorizo!", a:"Persona que es valerosa", b:"Persona grandiosa", c:"Persona que es timida", country:"Chile", level:5)
Question.create(title:"Wena guacho!", a:"Hola amigo", b:"Hola señor", c:"Saludar a alguien desconocido", country:"Chile", level:5)
Question.create(title:"Cacha ese loco esta entero curao", a:"Mira esa persona esta muy ebria", b:"Observar fijamente", c:"Ve a esa persona", country:"Chile", level:5)
#5
Question.create(title:"Vo apagai tele a media noche", a:"Se va a dormir temprano", b:"Apagar el televisor", c:"Ordenar a alguien", country:"Chile", level:5)
Question.create(title:"Uyyy! se le quemo el arroz", a:"Burlarse de una frase gay", b:" Molestar a alguien gay", c:"Hacer parecer que eres gay", country:"Chile", level:5)
Question.create(title:"La dura que esto esta belico", a:"Situacion muy dificil", b:"Nadie entiende lo que esta pasando", c:"Momento en que tu cerebro explota", country:"Chile", level:5)
